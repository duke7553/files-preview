...
namespace Files.Dialogs
{
    public sealed partial class BitlockerDialog : ContentDialog
    {
        ...
        private void BitlockerInput_TextChanged(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        public new IAsyncOperation<ContentDialogResult> ShowAsync()
        {
            ...
            this.PreviewKeyDown += (sender, e) =>
            {
                ...
                {
                    var element = Microsoft.UI.Xaml.Input.FocusManager.GetFocusedElement() as Button;
