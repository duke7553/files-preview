...
namespace Files.Views.LayoutModes
{
    public sealed partial class DetailsLayoutBrowser : BaseLayout
    {
        ...
        private Microsoft.UI.Dispatching.DispatcherQueueTimer renameDoubleClickTimer;
        private Microsoft.UI.Dispatching.DispatcherQueueTimer renameDoubleClickTimeoutTimer;
        ...
        public DetailsLayoutBrowser() : base()
        {
            ...
            renameDoubleClickTimer = DispatcherQueue.CreateTimer();
            renameDoubleClickTimeoutTimer = DispatcherQueue.CreateTimer();
        }
        ...
        {
            var ctrlPressed = KeyboardInput.GetKeyStateForCurrentThread(VirtualKey.Control).HasFlag(CoreVirtualKeyStates.Down);
            var shiftPressed = KeyboardInput.GetKeyStateForCurrentThread(VirtualKey.Shift).HasFlag(CoreVirtualKeyStates.Down);
        ...
        protected override void OnCharacterReceived(CharacterReceivedRoutedEventArgs args)
        {
